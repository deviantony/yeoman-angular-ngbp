module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    /**
     * We are also able to start a simple Express web server to use our
   ...
   * before watching for changes. The watch task also take care of starting
   * the Express web server via the `express` task.
   */
