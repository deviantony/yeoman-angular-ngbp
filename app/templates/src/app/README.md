...
to gain a better understanding of how it is used as well as to get a
...
The `templates-app` and `templates-common` modules are generated by the html2js Grunt plugin.
